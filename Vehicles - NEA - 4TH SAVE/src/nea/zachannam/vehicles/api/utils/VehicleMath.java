package nea.zachannam.vehicles.api.utils;
...
public final class VehicleMath {
	 ...
	 * @return
	 */
	public static VehicleLocation getNextLocation(VehicleLocation paramBaseLocation, double paramSteeringAngle, double paramMeterPerTick, double paramVehicleLength, boolean inReverse) {
		...
		// }
		paramSteeringAngle = inReverse ? -paramSteeringAngle : paramSteeringAngle;
